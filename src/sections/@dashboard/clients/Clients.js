...
export default function Clients({ title, total, icon, color = 'primary', sx, ...other }) {
    ...
    <>
      <Card sx={{
        ...
        <Box sx={{
          ...
          <Box>
            <Button variant="contained" onClick={handleOpen}>New Clients</Button>
            {/* <Typography
            variant="p"
            sx={{
              p:1,
          ...
          >
            ...
            >
              <Box sx={style}>
                ...
                <Typography variant='p' sx={{ my: 1 }}>Enter all the <b>mandatory</b> fields below. You may go in and update their profile after.</Typography>

                <Typography variant='subtitle2' sx={{ my: 1 }}>Type</Typography>
                ...
                <Typography variant='subtitle2' sx={{ my: 1 }}>Company</Typography>
                <TextField placeholder="Company Name" size="small" fullWidth />

                <Typography variant='subtitle2' sx={{ my: 1 }}>Email Address</Typography>
                <TextField placeholder="Email Address" size="small" fullWidth />

                <Stack direction="row" spacing={2}>
                  <Box sx={{ width: '50%' }}>
                    <Typography variant='subtitle2' sx={{ my: 1 }}>First Name</Typography>
                    <TextField placeholder="Contact First Name" size="small" fullWidth />
                  </Box>

                  <Box sx={{ width: '50%' }}>
                    <Typography variant='subtitle2' sx={{ my: 1 }}>Last Name</Typography>
                    <TextField placeholder="Contact Last Name" size="small" fullWidth />
                  </Box>
                </Stack>
                <Stack direction='row' spacing={2} sx={{ minWidth: "100%" }}>
                  <Box sx={{ width: '50%' }}>
                    <Typography variant='subtitle2' sx={{ my: 1 }}>Password</Typography>
                    <TextField placeholder="*****" size="small" fullWidth />
                  </Box>
                  <Box sx={{ width: '50%' }}>
                    <Typography variant='subtitle2' sx={{ my: 1 }}>Confirm Password</Typography>
                    <TextField placeholder="*****" size="small" fullWidth />
                  </Box>
                </Stack>
                <Stack direction='row' spacing={2}>
                  <Box sx={{ width: "50%" }}>
                    <Typography variant='subtitle2' sx={{ my: 1 }}>Account Type</Typography>
                    <FormControl size="small" fullWidth>
                      <Select
                        value={range}
                        onChange={handleChange}
                  ...
                  <Box sx={{ width: '50%' }}>
                    <Typography variant='subtitle2' sx={{ my: 1 }}>Default Currency</Typography>
                    <FormControl size="small" fullWidth>
                      <Select
                        value={range}
                        onChange={handleChange}
                        ...
                        inputProps={{ 'aria-label': 'Without label' }}
                      >
                        {currency.map(current => <MenuItem value={current}>{current}</MenuItem>)}
                      </Select>
                    </FormControl>
                  </Box>
                </Stack>
