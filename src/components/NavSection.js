...
function NavItem({ item, active }) {
  ...
  const { title, path, icon, values, info, children } = item;
  ...
  const expandOpen = () => setNavOpen(!open)
    ...
    return (
      <>
        ...
        >
          ...
          {/* {navOpen ? <ExpandLessIcon /> : <ExpandMoreIcon />} */}
          {info && info}
          <Iconify
        ...
        {values && <Collapse in={open} timeout="auto" unmountOnExit>
